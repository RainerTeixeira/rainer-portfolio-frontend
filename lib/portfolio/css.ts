/**
 * Constantes e Utilitários CSS
 *
 * Módulo com constantes de classes CSS padronizadas e função para merge de classes.
 * Fornece helpers essenciais para trabalhar com Tailwind CSS de forma consistente.
 *
 * ## Exportações
 *
 ...
 * - `ANIMATION_DELAYS` - Delays padronizados para animações
 *
 * ### Funções Utilitárias
 * - `cn()` - Merge inteligente de classes CSS (tailwind-merge)
 *
 * ## Uso
 *
 * ```typescript
 ...
 * @fileoverview Constantes CSS e função de merge de classes
