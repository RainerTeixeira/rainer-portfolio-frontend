 ...
 *
 * Hook que analisa a força de uma senha em tempo real baseado em múltiplos
 * critérios de segurança. Avalia comprimento, maiúsculas, minúsculas, números
 * e caracteres especiais. Ideal para formulários de cadastro e alteração.
 *
 * @module components/dashboard/hooks/use-password-strength
