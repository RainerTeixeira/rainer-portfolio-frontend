 ...
 *
 * Serviço de upload e gerenciamento de imagens usando as rotas do backend.
 * O frontend não precisa mais das variáveis NEXT_PUBLIC_CLOUDINARY_*.
 *
 * @fileoverview Integração com Cloudinary usando backend
 ...
 *
 * Faz upload via backend (rota /cloudinary).
 * Retorna a URL hospedada.
 *
...
export async function uploadToCloudinary(
  file: File,
  _options: CloudinaryUploadOptions = {},
