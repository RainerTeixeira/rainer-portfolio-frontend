              ...
              <Card className="h-full hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/50 group">
                <CardHeader>
                  <div className="flex items-center gap-2 mb-2">
                    {post.category && (
                      <Badge variant="secondary" className="bg-gray-500/10 text-gray-600 dark:text-gray-400 border-gray-500/30">{post.category.name}</Badge>
                    )}
                    {post.featured && (
                ...
                <CardContent>
                  ...
                  <div className="mt-3 pt-3 border-t">
                    <ReadingTime readTime={post.readTime} className="text-xs" />
                  </div>
                </CardContent>
              </Card>
            </Link>
