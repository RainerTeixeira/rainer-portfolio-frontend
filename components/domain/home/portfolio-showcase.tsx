 ...
 *
 * @module components/domain/home/portfolio-showcase
...
import { PROJETOS } from '@/constants/content/home/portfolio';
import { REDES_SOCIAIS } from '@/constants/metadata/comum/social';
...
export function PortfolioShowcase() {
  ...
  const projects = PROJETOS.map(proj => ({
    ...
    github: 'github' in proj.links ? proj.links.github : undefined,
    demo: 'demo' in proj.links ? proj.links.demo : undefined,
  }));
