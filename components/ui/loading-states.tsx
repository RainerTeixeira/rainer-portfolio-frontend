 ...
 * 
 * Componentes padronizados para estados de carregamento.
 ...
 * 
 * @fileoverview Loading states padronizados
...
export function FullPageLoader({ message = 'Carregando...' }: FullPageLoaderProps) {
  return (
    <div 
      className="min-h-screen w-full flex flex-col items-center justify-center bg-background dark:bg-gradient-to-b dark:from-black dark:via-gray-900 dark:to-black"
      role="status"
      aria-label={message}
    >
...
export function EmptyState({ 
  ...
  return (
    <div className="text-center py-12 px-4">
      <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-cyan-500/10 to-purple-500/10 dark:from-cyan-400/10 dark:to-purple-400/10 border border-cyan-400/30 mb-6">
        <Icon className="w-8 h-8 sm:w-10 sm:h-10 text-cyan-600 dark:text-cyan-400" aria-hidden="true" />
      </div>
