/**
 * Hook para Newsletter Subscription
 * 
 * Gerencia inscrição de usuários na newsletter com validação,
 * estados de loading/sucesso e feedback via toast.
 * 
 * Funcionalidades:
 * - Validação de email
 * - Estados de loading e sucesso
 * - Integração com API (simulada por enquanto)
 ...
 * 
 * @example
 * import { useNewsletter } from '@/components/blog/hooks'
 * 
