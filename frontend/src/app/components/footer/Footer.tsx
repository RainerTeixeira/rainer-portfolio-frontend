...
const Footer: React.FC = () => {
  // Constantes para os dados de serviços, links e informações de contato
  const services = [
    ...
    <div className="pt-[5rem] pb-[3rem] bg-gray-900">
      <div className="w-[80%] pb-[2rem] border-b-[2px] border-b-gray-300 border-opacity-50 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[3rem] items-start">
        ...
        <div>
          ...
          <p className="mt-[1rem] text-white">{contactInfo.email}</p>
          <p className="text-red-300 text-[19px] font-bold">{contactInfo.phone}</p>
        </div>
