...
/**
 * Página 404 - Cyber Worlds Runner
 * 
 * @fileoverview Jogo de plataforma com 10 mundos temáticos + dark/light mode
...
const WORLDS = [
  {
    ...
    theme: 'cyberpunk',
    icon: Zap,
    colors: { bg: 'from-purple-900 via-black to-cyan-900', platform: '#06b6d4', enemy: '#a855f7', coin: '#fbbf24' },
  ...
  },
  {
    ...
    theme: 'mario',
    icon: Star,
    colors: { bg: 'from-blue-400 via-green-300 to-blue-500', platform: '#8B4513', enemy: '#ef4444', coin: '#fbbf24' },
  ...
  },
  {
    ...
    theme: 'doom',
    icon: Flame,
    colors: { bg: 'from-red-950 via-black to-orange-950', platform: '#8B0000', enemy: '#ff0000', coin: '#ff6600' },
  ...
  },
  {
    ...
    theme: 'contra',
    icon: Skull,
    colors: { bg: 'from-gray-800 via-green-900 to-gray-700', platform: '#4a5568', enemy: '#10b981', coin: '#60a5fa' },
  ...
  },
  {
    ...
    theme: 'pacman',
    icon: Ghost,
    colors: { bg: 'from-blue-900 via-black to-purple-900', platform: '#1e40af', enemy: '#ec4899', coin: '#fef08a' },
  ...
  },
  {
    ...
    theme: 'crystal',
    icon: Gem,
    colors: { bg: 'from-indigo-900 via-purple-800 to-pink-900', platform: '#a78bfa', enemy: '#c084fc', coin: '#f0abfc' },
  ...
  },
  {
    ...
    theme: 'space',
    icon: Sparkles,
    colors: { bg: 'from-gray-900 via-blue-950 to-black', platform: '#475569', enemy: '#0ea5e9', coin: '#fbbf24' },
  ...
  },
  {
    ...
    theme: 'jungle',
    icon: Zap,
    colors: { bg: 'from-green-900 via-emerald-800 to-teal-900', platform: '#10b981', enemy: '#f59e0b', coin: '#fbbf24' },
  ...
  },
  {
    ...
    theme: 'castle',
    icon: Crown,
    colors: { bg: 'from-slate-900 via-gray-900 to-stone-900', platform: '#6b7280', enemy: '#7c3aed', coin: '#fbbf24' },
  ...
  },
  {
    ...
    theme: 'matrix',
    icon: Zap,
    colors: { bg: 'from-black via-green-950 to-black', platform: '#22c55e', enemy: '#ef4444', coin: '#22c55e' },
...
export default function NotFound() {
  ...
  const initWorld = useCallback((worldId: number) => {
    ...
    switch(worldId) {
      case 1: // Cyber City - Fácil (Escada ascendente suave)
        platforms = [
          { x: 0, y: CANVAS_HEIGHT - 40, width: 250, height: 40, color: platformColor },
        ...
        enemies = [
          { x: 200, y: 340, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
        ]
        coinPositions = [
          { x: 200, y: 330 }, { x: 400, y: 270 }, { x: 600, y: 210 }, { x: 450, y: 150 }
        ]
        break
        
      case 2: // Mario Land - Fácil/Médio (Pulos laterais)
        platforms = [
          { x: 50, y: CANVAS_HEIGHT - 40, width: 180, height: 40, color: platformColor },
          { x: 570, y: CANVAS_HEIGHT - 40, width: 180, height: 40, color: platformColor },
        ...
        enemies = [
          { x: 150, y: 340, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 330, y: 300, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
        ]
        coinPositions = [
          { x: 150, y: 330 }, { x: 320, y: 290 }, { x: 470, y: 250 }, { x: 630, y: 210 }, { x: 350, y: 150 }
        ]
        break
        
      case 3: // DOOM Hell - Médio (Plataformas centralizadas - abismo dos lados)
        platforms = [
          { x: 300, y: CANVAS_HEIGHT - 40, width: 200, height: 40, color: platformColor },
        ...
        enemies = [
          { x: 230, y: 340, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 380, y: 260, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
          { x: 280, y: 200, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
        ]
        coinPositions = [
          { x: 250, y: 340 }, { x: 530, y: 340 }, { x: 180, y: 270 }, { x: 380, y: 250 }, { x: 380, y: 110 }
        ]
        break
        
      case 4: // Contra Base - Médio/Difícil (Zigzag militar)
        platforms = [
          { x: 0, y: CANVAS_HEIGHT - 40, width: 150, height: 40, color: platformColor },
          { x: 650, y: CANVAS_HEIGHT - 40, width: 150, height: 40, color: platformColor },
        ...
        enemies = [
          { x: 100, y: 340, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 270, y: 290, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
          { x: 440, y: 240, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 610, y: 190, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
        ]
        coinPositions = [
          { x: 110, y: 330 }, { x: 280, y: 280 }, { x: 450, y: 230 }, { x: 620, y: 180 }, { x: 380, y: 50 }, { x: 700, y: 380 }
        ]
        break
        
      case 5: // Pac-Maze - Difícil (Labirinto - blocos alternados)
        platforms = [
          { x: 0, y: CANVAS_HEIGHT - 40, width: 120, height: 40, color: platformColor },
          { x: 680, y: CANVAS_HEIGHT - 40, width: 120, height: 40, color: platformColor },
          // Linha inferior
        ...
        enemies = [
          { x: 80, y: 360, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 210, y: 360, width: 30, height: 30, direction: -1, type: world.theme, color: '#a855f7' },
          { x: 140, y: 300, width: 30, height: 30, direction: 1, type: world.theme, color: '#ec4899' },
          { x: 530, y: 300, width: 30, height: 30, direction: -1, type: world.theme, color: '#06b6d4' },
          { x: 340, y: 230, width: 30, height: 30, direction: 1, type: world.theme, color: '#fbbf24' },
        ]
        coinPositions = [
          { x: 85, y: 360 }, { x: 215, y: 360 }, { x: 345, y: 360 }, { x: 145, y: 290 }, { x: 345, y: 220 }, { x: 210, y: 150 }, { x: 350, y: 70 }
        ]
        break
      ...
      case 6: // Crystal Cave - Difícil (Pirâmide invertida)
        ...
        enemies = [
          { x: 380, y: 350, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 220, y: 300, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
          { x: 540, y: 300, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 120, y: 240, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
          { x: 640, y: 240, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
        ]
        coinPositions = [
          { x: 380, y: 340 }, { x: 230, y: 290 }, { x: 550, y: 290 }, { x: 80, y: 230 }, { x: 700, y: 230 }, { x: 380, y: 90 }
        ]
        break
        
      case 7: // Space Station - Muito Difícil (Órbitas circulares)
        platforms = [
          { x: 30, y: CANVAS_HEIGHT - 40, width: 100, height: 40, color: platformColor },
          { x: 670, y: CANVAS_HEIGHT - 40, width: 100, height: 40, color: platformColor },
          // Círculo esquerdo
        ...
        enemies = [
          { x: 90, y: 340, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 60, y: 280, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
          { x: 670, y: 340, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 700, y: 280, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
          { x: 380, y: 260, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 350, y: 140, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
        ]
        coinPositions = [
          { x: 90, y: 330 }, { x: 60, y: 270 }, { x: 680, y: 330 }, { x: 710, y: 270 }, { x: 380, y: 250 }, { x: 380, y: 130 }, { x: 380, y: 50 }, { x: 170, y: 160 }
        ]
        break
        
      case 8: // Neon Jungle - Muito Difícil (Trepadeira - vertical íngreme)
        platforms = [
          { x: 20, y: CANVAS_HEIGHT - 40, width: 80, height: 40, color: platformColor },
          { x: 700, y: CANVAS_HEIGHT - 40, width: 80, height: 40, color: platformColor },
        ...
        enemies = [
          { x: 50, y: 360, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 90, y: 320, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
          { x: 120, y: 280, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 150, y: 240, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
          { x: 180, y: 200, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 400, y: 60, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
          { x: 650, y: 160, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
        ]
        coinPositions = [
          { x: 55, y: 360 }, { x: 100, y: 310 }, { x: 145, y: 270 }, { x: 175, y: 230 }, { x: 210, y: 190 }, { x: 240, y: 150 }, { x: 280, y: 80 }, { x: 420, y: 50 }, { x: 560, y: 90 }
        ]
        break
        
      case 9: // Dark Castle - Extremo (Torres gêmeas perigosas)
        platforms = [
          { x: 20, y: CANVAS_HEIGHT - 40, width: 70, height: 40, color: platformColor },
          { x: 710, y: CANVAS_HEIGHT - 40, width: 70, height: 40, color: platformColor },
          // Torre esquerda
        ...
        enemies = [
          { x: 40, y: 360, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 35, y: 320, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
          { x: 40, y: 280, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 730, y: 360, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
          { x: 720, y: 320, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 350, y: 300, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
          { x: 380, y: 180, width: 30, height: 30, direction: 1, type: world.theme, color: enemyColor },
          { x: 370, y: 60, width: 30, height: 30, direction: -1, type: world.theme, color: enemyColor },
        ]
        coinPositions = [
          { x: 45, y: 360 }, { x: 40, y: 260 }, { x: 40, y: 160 }, { x: 735, y: 360 }, { x: 730, y: 260 }, { x: 380, y: 290 }, { x: 380, y: 170 }, { x: 380, y: 50 }, { x: 50, y: 80 }, { x: 740, y: 150 }
        ]
        break
        
      case 10: // Digital Matrix - MASTER (Código binário - linha única insana)
        platforms = [
          { x: 10, y: CANVAS_HEIGHT - 40, width: 50, height: 40, color: platformColor },
          { x: 740, y: CANVAS_HEIGHT - 40, width: 50, height: 40, color: platformColor },
        ...
        enemies = [
          { x: 30, y: 370, width: 28, height: 28, direction: 1, type: world.theme, color: enemyColor },
          { x: 100, y: 350, width: 28, height: 28, direction: -1, type: world.theme, color: enemyColor },
          { x: 165, y: 330, width: 28, height: 28, direction: 1, type: world.theme, color: enemyColor },
          { x: 230, y: 310, width: 28, height: 28, direction: -1, type: world.theme, color: enemyColor },
          { x: 295, y: 290, width: 28, height: 28, direction: 1, type: world.theme, color: enemyColor },
          { x: 360, y: 270, width: 28, height: 28, direction: -1, type: world.theme, color: enemyColor },
          { x: 425, y: 250, width: 28, height: 28, direction: 1, type: world.theme, color: enemyColor },
          { x: 490, y: 230, width: 28, height: 28, direction: -1, type: world.theme, color: enemyColor },
          { x: 555, y: 210, width: 28, height: 28, direction: 1, type: world.theme, color: enemyColor },
          { x: 685, y: 170, width: 28, height: 28, direction: -1, type: world.theme, color: enemyColor },
        ]
        coinPositions = [
          { x: 35, y: 375 }, { x: 105, y: 355 }, { x: 170, y: 335 }, { x: 235, y: 315 },
          { x: 300, y: 295 }, { x: 365, y: 275 }, { x: 430, y: 255 }, { x: 495, y: 235 },
          { x: 560, y: 215 }, { x: 625, y: 195 }, { x: 690, y: 175 }, { x: 420, y: 25 }
        ]
        break
    }
  ...
  const render = useCallback(() => {
    ...
    coinsRef.current.forEach(coin => {
      if (!coin.collected) {
        ...
        drawIcon(ctx, 'coin', coin.x + coin.width / 2 + pulse, coin.y + coin.height / 2, coin.width + pulse * 2, world.colors.coin, true)
      }
    })
    ...
    enemiesRef.current.forEach(enemy => {
      ...
      drawIcon(ctx, enemyIconType, enemy.x + enemy.width / 2, enemy.y + enemy.height / 2, enemy.width, enemy.color, true)
    })
    
    // Jogador
    const playerColor = isDark ? '#22d3ee' : '#06b6d4'
    drawIcon(ctx, 'player', player.x + PLAYER_SIZE / 2, player.y + PLAYER_SIZE / 2, PLAYER_SIZE, playerColor, true)
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-background via-background to-muted flex items-center justify-center p-4 relative overflow-hidden">
      {/* Efeitos de fundo */}
                ...
                <CardContent>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                    {WORLDS.map((world) => {
                      ...
                      const enemyCount = world.id === 10 ? 10 : world.id >= 7 ? 6 + world.id - 7 : world.id
                      const coinCount = world.id === 10 ? 12 : world.id >= 5 ? 5 + world.id : 4 + world.id
                      ...
                      return (
                        ...
                        >
                          <CardContent className="p-4 text-center">
                            ...
                            <Badge variant="outline" className="text-[10px] mb-2">{world.difficulty}</Badge>
                  ...
                  <Card className="border-yellow-500/30 bg-yellow-500/5">
                    <CardContent className="pt-4">
                      <div className="text-center">
                        ...
                        <p className="text-xs font-semibold text-foreground mb-1">🎁 Easter Egg 404</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_800px_1fr] gap-4">
            ...
            <Card>
              <CardContent className="pt-4 space-y-3">
                <div>
                  <div className="text-[10px] text-muted-foreground mb-1">MUNDO</div>
                ...
                <div>
                  <div className="text-[10px] text-muted-foreground mb-1">PONTOS</div>
                  <div className="text-2xl font-black">{score}</div>
                </div>
                
                <div>
                  <div className="text-[10px] text-muted-foreground mb-1">VIDAS</div>
