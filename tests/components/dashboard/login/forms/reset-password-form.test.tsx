...
jest.mock('@/components/domain/dashboard/login/forms/reset-password-form', () => {
...
import { ResetPasswordForm } from '@/components/domain/dashboard/login/forms/reset-password-form';
