/**
 * Teste de Login com GitHub usando Puppeteer + Stealth Plugin
 *
 * Este teste usa puppeteer-extra com stealth plugin para evitar
 * detecção de automação pelo GitHub.
 */
...
describe('GitHub OAuth com Puppeteer Stealth', () => {
  let browser: Browser;
  let page: Page;

  beforeAll(async () => {
    console.log('\n═══════════════════════════════════════════════════════');
    console.log('  🔒 Iniciando Puppeteer com Stealth Plugin (GitHub)');
    console.log('═══════════════════════════════════════════════════════\n');
  ...
  test('Login com GitHub - Fluxo Completo', async () => {
    console.log('───────────────────────────────────────────────────────');
    ...
    await page.screenshot({
      path: 'test-results/github-stealth-step1-login.png',
      fullPage: true,
    });
    ...
    await page.waitForSelector('button:has-text("GitHub")', { timeout: 10000 });
    ...
    await page.screenshot({
      path: 'test-results/github-stealth-step3-oauth.png',
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: 'test-results/github-stealth-step4-callback.png',
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: 'test-results/github-stealth-step6-final.png',
      fullPage: true,
    });
